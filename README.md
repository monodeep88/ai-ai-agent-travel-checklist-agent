# Travel Checklist Agent - AI Agent

## Project Overview

Travel Checklist Agent - AI Agent is a complete full-stack AI project for **AI Agent**. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-ai-agent-travel-checklist-agent/
  backend/
    app/
      main.py
      config.py
...
Goal intake -> planner -> tool selector -> reasoning step -> final task plan.
