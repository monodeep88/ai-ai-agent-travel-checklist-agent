...
def _tool_call(question: str) -> str:
    ...
    return "Checklist: " + " | ".join(planning_checklist(question)[:3])
...
def run_pipeline(question: str) -> AskResponse:
    ...
    if FLOW_STYLE in {"Agentic RAG", "AI Agent", "Multi-Agent AI", "LangGraph workflow", "LangChain tool-calling agent"}:
