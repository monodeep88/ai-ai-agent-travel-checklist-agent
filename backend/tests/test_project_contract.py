...
from app.config import PROJECT_SUBJECT, PROJECT_TYPE
...
def test_project_metadata():
    assert PROJECT_TYPE == 'AI Agent'
    assert PROJECT_SUBJECT == 'Travel Checklist Agent'
...
def test_pipeline_returns_answer_sources_and_steps():
    ...
    assert result.steps
    assert result.project_type == 'AI Agent'
